function get_blox_element_portfolio($content, $attrs){
    $tools = '<div class="blox_item_actions"> \
                    ...
                    <a href="javascript:;" class="icon-remove action_remove"></a> \
            </div>';
        ...
        .click(function(){
            ...
            },
            {
                ...
                options: [
                    ...
                    { value: 'centered', label: '4. Centered one column' },
                    { value: 'grid2', label: '5. Grid 2 columns' },
                    { value: 'grid3', label: '6. Grid 3 columns' },
                    { value: 'grid4', label: '7. Grid 4 columns' },
                    { value: 'grid2pure', label: '8. Grid 2 columns, Over title and without overlay icons' },
                    { value: 'grid3pure', label: '9. Grid 3 columns, Over title and without overlay icons' },
                    { value: 'grid4pure', label: '10. Grid 4 columns, Over title and without overlay icons' }
                ]
            },
            {
                type: 'number',
                id: 'blox_element_option_height',
                label: 'Image height (optional, for grid layout)',
                std: 200,
            ...
            show_blox_form('Edit Portfolio', form_element, function($form){
                ...
                //$this.attr('categories', jQuery('#blox_element_option_categories').val());
