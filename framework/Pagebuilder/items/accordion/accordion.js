...
function get_blox_element_accordion_item($attrs, $content){
	$actions_top = '<div class="blox_action_buttons clearfix"> \
                            <a href="javascript:;" class="ac_edit_current"><i class="icon-fixed-width"></i></a> \
                            <a href="javascript:;" class="ac_clone_current"><i class="icon-fixed-width"></i></a> \
                            <a href="javascript:;" class="ac_remove_current"><i class="icon-fixed-width"></i></a> \
                            <a href="javascript:;" class="ac_add_blox_elem" data-rel="top"><i class="icon-fixed-width"></i> Add Element</a> \
                    </div>';
	$actions_bottom = '<div class="blox_action_buttons"> \
                            <a href="javascript:;" class="ac_add_blox_elem float_none" data-rel="bottom"><i class="icon-fixed-width"></i> Add Element</a> \
                    </div>';
