...
function get_blox_element_toggle($content, $attrs, $title){
    ...
    return '<div class="blox_item blox_toggle" '+($attrs!=undefined ? $attrs : '')+'><div class="blox_item_title"><i class="icon-expand-alt"></i> <span class="blox_toggle_title">'+($title!=undefined ? $title : 'Blox Toggle')+'</span>'+$tools+'</div><div class="blox_item_content">'+($content!=undefined ? $content : '')+'</div></div>';
}
