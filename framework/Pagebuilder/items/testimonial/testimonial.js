...
function get_blox_element_testimonial($content, $attrs){
    ...
    + '</div> \
                <div class="blox_accordion_bottom_tb"> \
                        <a href="javascript:;" class="blox_ac_item_add"><i class="icon-fixed-width"></i> Add Testimonial Item</a> \
                </div> \
        </div>';
}
    ...
    jQuery('.blox_testimonial').each(function(){
        ...
        .click(function(){
            ...
            },
            {
                ...
                options: [
                    { value: 'single_color', label: 'Fill Color only Quotes' },
                    { value: 'full_color', label: 'Full Color Quote and Author area' }
                ]
            }
            ];
