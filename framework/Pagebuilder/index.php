...
require_once file_require(dirname(__FILE__).'/inc/common_functions.php');
require_once file_require(dirname(__FILE__).'/inc/metro_content.php');
require_once file_require(dirname(__FILE__).'/inc/loop_layouts.php');
require_once file_require(dirname(__FILE__).'/inc/blox_aq_resizer.php');
require_once file_require(dirname(__FILE__).'/render.php');
